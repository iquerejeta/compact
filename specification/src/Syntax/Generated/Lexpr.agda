...
-- ***
-- *** The definitions in this file were automatically generated from the `Lexpr` Nanopass IR
-- *** 
-- *** TIMESTAMP: 2025-06-26 10:40:38 
-- *** 
...
module Syntax.Generated.Lexpr where
  mutual
    ...
    data Expression : Set where
      let* : List Argument -> List Expression -> Expression -> Expression
    ...
    data Export-Declaration : Set where
      export : List src -> List String -> Export-Declaration

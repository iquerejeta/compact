...
export type InitialStateParams<C extends Contract<any, any>> = C['initialState'] extends (
    c: ConstructorContext,
    ...a: infer A
) => any
    ? A
    : never;
...
export function startContract<PS, W extends Witnesses<PS>, C extends Contract<PS, W>>(
    module: Module<C, W>,
    witnesses: W,
    privateState: PS,
